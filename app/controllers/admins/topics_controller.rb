module Admins
  class TopicsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @topic.save
          format.html { redirect_to [:admins,@topic], notice: 'Topic was successfully created.' }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to admins_topics_url, notice: 'Topic was successfully deleted.' }
        format.json { head :no_content }
      end
    end
