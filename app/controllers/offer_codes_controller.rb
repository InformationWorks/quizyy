  ...
  def create
    ...
    respond_to do |format|
      if @offer_code.save
        @offer_codes = OfferCode.all
        @offers = Offer.all
        format.html { redirect_to offers_url, notice: 'Offer code was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @offer_code.update_attributes(params[:offer_code])
        @offer_codes = OfferCode.all
        @offers = Offer.all
        format.html { redirect_to offers_url, notice: 'Offer code was successfully updated.' }
